...
1. Кассандра печатает догадку (guess)
...
1. Кассандра закончила печатать догадку
...
1. Новое состояние догадки Кассандры

    Эти сообщения получают только Наблюдатели — по мере того, как Кассандра вводит догадку. Они нужны для того, чтобы прибавить игре драматизма, привлекая внимание к мукам Кассандры.
...
1. Новое сообщение в чат
    ...
    Писать в чат могут только игроки — сообщения наблюдателей будут проигнорированы сервером.
...
1. Новое состояние догадки Кассандры
    ...
    Делать догадки может только Кассандра, догадки других пользователей будут проигнорированы сервером.
...
1. Новое состояние подсказки Художника
    ...
    Делать подсказки может только Художник. Подсказки других пользователей будут проигнорированы сервером.
...
1. Судья принял решение
    ...
    Каждый судья в течение игры обязательно должен принять решение, является ли художник читером. Он принимает решение независимо от Кассандры и другого судьи. После того, как решение получено сервером, судья не может изменить своего мнения.
